...
public interface FutureResolved<T> {
     ...
     * @throws Exception if the resolved future cannot be handled, will not cause the target future to be failed.
     *             Behavior is defined by the implementation of {@link AsyncCaller#resolve(FutureResolved, Object)}.
