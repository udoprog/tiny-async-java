...
public interface FutureDone<T> {
     ...
     * AsyncCaller#fail(FutureDone, Throwable)}.
     ...
     * @throws Exception if the resolved future cannot be handled, will <em>not</em> cause the
     * target future to be failed. Behavior is defined by the implementation of {@link
     * AsyncCaller#resolve(FutureDone, Object)}.
     ...
     *
     * @throws Exception if unable to handle the cancelled future, will <em>not</em> cause the
     * target future to be failed. Behavior is defined by the implementation of {@link
     * AsyncCaller#cancel(FutureDone)}.
