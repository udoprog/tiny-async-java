...
public interface StreamCollector<S, T> {
     ...
     * @throws Exception if unable to process the failed future, this will cause the target future
     * to be failed. {@link #end(int, int, int)} will not be called will not be called, and all
     * other futures associated with the collector will be cancelled.
     */
     ...
     *
     * @throws Exception if unable to process the cancelled future, this will cause the target
     * future to be failed. {@link #end(int, int, int)} will not be called, and all other futures
     * associated with the collector will be cancelled.
     */
     ...
     * target future to be failed. {@link #end(int, int, int)} will not be called will not be
     * called, and all other futures associated with the collector will be cancelled.
     */
