...
public class FailedAsyncFutureTest {
    ...
    public void before() {
        ...
        failed = new FailedAsyncFuture<Boolean>(async, caller, error);
    }
    ...
    public void testImmediatelyResolved() throws Exception {
        final AsyncFuture<Integer> c = new FailedAsyncFuture<Integer>(async, caller, error);
        c.on(handle);
    }
