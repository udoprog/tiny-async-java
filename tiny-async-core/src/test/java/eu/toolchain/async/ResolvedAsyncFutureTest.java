...
public class ResolvedAsyncFutureTest {
    ...
    public void before() {
        ...
        future = new ResolvedAsyncFuture<>(async, caller, result);
    }
    ...
    public void testImmediatelyResolved() throws Exception {
        final AsyncFuture<Object> c = new ResolvedAsyncFuture<>(async, caller, result);
        c.on(handle);
    }
